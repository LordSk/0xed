...
void ImGui::Scrollbar(ImGuiAxis axis)
{
	...
	bb.Expand(ImVec2(-ImClamp((float)(int)((bb.Max.x - bb.Min.x - 2.0f) * 0.5f), 0.0f, style.GrabPadding), -ImClamp((float)(int)((bb.Max.y - bb.Min.y - 2.0f) * 0.5f), 0.0f, style.GrabPadding)));
