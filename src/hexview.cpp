...
void HexView::doUiHexViewWindow()
{
	...
	ImGui::BeginChild("#child_panel", ImVec2(0, 0), false,
		...
		selection.hoverEnd = MIN(selection.hoverEnd, fileBufferOff.size); // FIXME: hover should behave like select
...
void uiHexDoHexPanel(i32 startLine, const u8* data, i64 dataSize, i32 columnCount, const CellColorBuffer& colorBuffer)
{
